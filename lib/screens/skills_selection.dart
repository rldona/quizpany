...
import 'package:quizpany/widgets/CategorieList.dart';
      ...
      body: ListView(children: <Widget>[
        Padding(
          ...
          child: Column(
            ...
            children: <Widget>[
              Image(image: AssetImage('assets/images/avatar.png'), fit: BoxFit.fitWidth, width: 100),
              SizedBox(height: 15),
              Text(
                'Pepe López López',
              ...
              SizedBox(
                ...
                child: RaisedButton(
                  child: Text(
                    'Compezar test'.toUpperCase(),
                    style: TextStyle(color: Colors.white, fontSize: 14, fontWeight: FontWeight.w600)
                  ),
                  color: Colors.blue,
                  onPressed: () => print('Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Test())'),
                ),
              )
            ],
          ),
